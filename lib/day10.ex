defmodule Day10 do
  ...
  def find_corrupted_input(line_str, acc), do:
    find_corrupted_input(String.codepoints(line_str), [], acc)
  ...
  defp find_missing_input(line_str, acc), do:
    find_missing_input(String.codepoints(line_str), [], acc)
  ...
  defp calc_score([p|t], acc), do:
    calc_score(t, acc * 5 + to_score(p))
