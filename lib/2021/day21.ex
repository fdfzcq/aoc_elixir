defmodule Year2021.Day21 do
  ...
  defp part1({position1, position2}), do: play1({1, position1, 0}, {1, 2, 3}, {2, position2, 0}, 0)
  ...
  defp play1({x, pos1, score1}, {n1, n2, n3}, {y, pos2, score2}, d) do
    play1({y, pos2, score2}, next_rolls(n3 + 1), add_to_score(x, score1, pos1, {n1, n2, n3}), d + 3)
  end
  ...
  defp play2({_, _, _}, {x, _, score2}, {win, mem}) when score2 >= 21, do:
    {Map.put(win, x, win[x] + 1), mem}
      ...
      nil ->
        ...
        |> Enum.reduce({acc, mem},
          fn n, {%{1 => win1, 2 => win2}, mem1} ->
            ...
            {%{1 => w1, 2 => w2}, mem2} = play2({y, pos2, score2}, {x, newpos1, newscore1}, {%{1 => 0, 2 => 0}, mem1})
            {
