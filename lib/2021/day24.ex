defmodule Year2021.Day24 do
  ...
  defp find_largest_valid_monad(_, _, z, mem, _) when z > 26 * 26 * 26 * 26 * 26, do: {mem, :invalid}
  defp find_largest_valid_monad(n, [h1, h2 | t], old_z, mem, monad) when old_z <= 26 * 26 * 26 * 26 * 26 do
    IO.inspect(monad)
    ...
    case MapSet.member?(mem, {v1, v2, v3, old_z}) do
      true -> {mem, :invalid}
      false ->
        new_z = case rem(old_z, 26) + v2 == n do
          true -> div(old_z, v1)
