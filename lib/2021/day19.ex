defmodule Year2021.Day19 do
  ...
  defp find_possible_scanner_coors(ref, cur, beacons),
    do:
  ...
  defp rotate([x, y, z]) do
    Enum.reduce([x, -x], [], fn v_x, acc ->
      Enum.reduce([y, -y], acc, fn v_y, a ->
        Enum.reduce([z, -z], a, fn v_z, b ->
          b ++ [[v_x, v_y, v_z]]
        end)
      end)
    end)
